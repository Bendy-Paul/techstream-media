...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="h4 fw-bold mb-0">Write Article</h2>
        <p class="text-muted small mb-0">Create a news post or company blog entry.</p>
    </div>
...
<form action="{{ route('company.articles.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row g-4">
        {{-- LEFT: Content --}}
        <div class="col-lg-8">
