...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="h4 fw-bold mb-0">Create Event</h2>
        <p class="text-muted small mb-0">Submitted events are reviewed before publishing.</p>
    </div>
...
<form action="{{ route('company.events.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row g-4">
        {{-- LEFT COLUMN --}}
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control form-control-lg @error('title') is-invalid @enderror"
                               value="{{ old('title') }}" placeholder="e.g. Tech Summit Lagos 2026" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                  rows="6" placeholder="Describe the event…" required>{{ old('description') }}</textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="is_virtual" id="isVirtual"
                               value="1" onchange="toggleLocation()" {{ old('is_virtual') ? 'checked' : '' }}>
                    ...
                    <div id="locationFields">
                        <div class="mb-3">
                            ...
                            <input type="text" name="location_name" class="form-control"
                                   value="{{ old('location_name') }}" placeholder="e.g. Eko Hotel & Suites">
                        </div>
                        <div class="mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="ticket_url" class="form-control"
                               value="{{ old('ticket_url') }}" placeholder="https://eventbrite.com/…">
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="form-text">Max 4MB. JPG, PNG or WebP.</div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    // Run on page load in case old() sets the checkbox
    toggleLocation();
</script>
@endsection
